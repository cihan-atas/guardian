...
import { faClockRotateLeft, faGavel, faServer, faUsers, faKey, faRightFromBracket, faChartBar, faGear, faInbox, faUserShield } from '@fortawesome/free-solid-svg-icons';
